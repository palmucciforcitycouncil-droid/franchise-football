...
export function PlayerDrawer({ player, open, onClose }: PlayerDrawerProps) {
  ...
  return (
    <Sheet open={open} onOpenChange={onClose}>
      <SheetContent className="bg-[#1a2332] border-l border-[#2d4a6f] w-[480px] overflow-y-auto" aria-describedby="player-details">
        {/* Header */}
        <div id="player-details" className="sr-only">Player details and statistics</div>
        <SheetHeader className="border-b border-[#2d4a6f] pb-4 mb-4">
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <SheetTitle className="text-white text-xl mb-1">{player.name}</SheetTitle>
