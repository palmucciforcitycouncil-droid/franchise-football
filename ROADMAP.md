...
Written 2026-09-09, after item 37 (roster-depth rotation); updated same day after item 38 (M1: Defensive TD), then again after item 39 (M3: Stats page redesign). Current state: 235 tests passing (1 skipped), MVP roughly 94% complete by scope, remaining gaps are well-understood and itemized below.
...
**Total remaining MVP: roughly 3-5 focused sessions**, most of them small-to-medium, now that M1 (the one chunk with real design risk) and M3 are done.
