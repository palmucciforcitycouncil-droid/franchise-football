...
Written 2026-09-09, after item 37 (roster-depth rotation); updated same day after item 38 (M1: Defensive TD), then again after item 39 (M3: Stats page redesign), then again after M2 (Kicking/Punting box score). Current state: 239 tests passing (1 skipped), MVP roughly 95% complete by scope, remaining gaps are well-understood and itemized below.
