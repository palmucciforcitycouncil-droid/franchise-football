...
# through here.
#
# 2026-09-20 (Brian's ask): fullbacks removed from the game entirely --
# HB is the only running-back position now. "FB": "HB" folds any legacy
# FB player (real save data, old JSON stores, re-imported rosters) into
# HB the same way every other retired code here does, rather than a
# separate one-off migration -- app/core/db.py's existing
# LEGACY_POSITION_MAP UPDATE loop picks this up automatically.
