...
export function BoxScore({ hideNavigation = false }: BoxScoreProps) {
            ...
            {team.playerStats.passing.map((player, idx) => (
              <tr key={idx} className="border-b border-[#2d4a6f]/30">
                <td className="py-2 pr-2">
                  ...
                  <ClickablePlayerName 
                    player={{ ...player, pos: 'QB', ovr: 75, age: 25 }}
            ...
            {team.playerStats.rushing.map((player, idx) => (
              <tr key={idx} className="border-b border-[#2d4a6f]/30">
                <td className="py-2 pr-2">
                  <span className="text-[#94a3b8] mr-2">{player.number}</span>
                  <ClickablePlayerName 
                    player={{ ...player, pos: 'RB', ovr: 75, age: 24 }}
                    className="text-white"
                  />
                </td>
            ...
            {team.playerStats.receiving.map((player, idx) => (
              <tr key={idx} className="border-b border-[#2d4a6f]/30">
                <td className="py-2 pr-2">
                  <span className="text-[#94a3b8] mr-2">{player.number}</span>
                  <ClickablePlayerName 
                    player={{ ...player, pos: 'WR', ovr: 75, age: 26 }}
                    className="text-white"
                  />
                </td>
            ...
            {team.playerStats.defense.map((player, idx) => (
              <tr key={idx} className="border-b border-[#2d4a6f]/30">
                <td className="py-2 pr-2">
                  <span className="text-[#94a3b8] mr-2">{player.number}</span>
                  <ClickablePlayerName 
                    player={{ ...player, pos: 'LB', ovr: 75, age: 27 }}
                    className="text-white"
                  />
                </td>
            ...
            {team.playerStats.kickReturns.map((player, idx) => (
              <tr key={idx} className="border-b border-[#2d4a6f]/30">
                <td className="py-2 pr-2">
                  <span className="text-[#94a3b8] mr-2">{player.number}</span>
                  <ClickablePlayerName 
                    player={{ ...player, pos: 'WR', ovr: 75, age: 25 }}
                    className="text-white"
                  />
                </td>
            ...
            {team.playerStats.kicking.map((player, idx) => (
              <tr key={idx} className="border-b border-[#2d4a6f]/30">
                <td className="py-2 pr-2">
                  <span className="text-[#94a3b8] mr-2">{player.number}</span>
                  <ClickablePlayerName 
                    player={{ ...player, pos: 'K', ovr: 75, age: 28 }}
                    className="text-white"
                  />
                </td>
            ...
            {team.playerStats.punting.map((player, idx) => (
              <tr key={idx} className="border-b border-[#2d4a6f]/30">
                <td className="py-2 pr-2">
                  <span className="text-[#94a3b8] mr-2">{player.number}</span>
                  <ClickablePlayerName 
                    player={{ ...player, pos: 'P', ovr: 75, age: 29 }}
                    className="text-white"
                  />
                </td>
        ...
        <div className="p-4">
          <Alert className="bg-[#991b1b]/20 border-[#dc2626] text-white">
            <AlertDescription className="text-sm">
              Couldn't load box score. Showing demo.
            </AlertDescription>
          </Alert>
        </div>
      )}
