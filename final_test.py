#!/usr/bin/env python3
"""
Corrected three-season simulation with proper home field advantage and realistic metrics.
"""
...
def corrected_three_season_test():
    """Run corrected three-season simulation with proper home field advantage"""
    ...
    def _yardage_targets_v2(season: int, home_id: int, away_id: int) -> Tuple[int, int, int, int]:
        ...
        # Target distributions (per team) - slightly higher for realism
    ...
    def _points_from_yards_v2_corrected(home_abbr: str, away_abbr: str) -> Tuple[int, int]:
        """Convert yardage to realistic scores with CORRECTED home field advantage."""
        base_seed = int(os.environ.get("LEAGUE_SEED", "2025"))
        ...
        # CORRECTED: Apply home-field advantage properly
        hfa_points = float(os.environ.get("HFA_POINTS", "1.6"))
        
        # Add HFA to home team's base points
    ...
    def simulate_realistic_pbp_events():
        ...
        # CORRECTED: Realistic NFL targets
    ...
    print("=== CORRECTED THREE-SEASON SIMULATION ===")
    print("Testing 272 games per season (NFL standard) for seasons 2025-2027")
    print("With CORRECTED home field advantage implementation")
    print()
    ...
    for season in range(2025, 2028):
        ...
        for game in range(272):
            ...
            h_score, a_score = _points_from_yards_v2_corrected(f"TEAM{home_id}", f"TEAM{away_id}")
    ...
    print("=== THREE-SEASON SUMMARY (816 GAMES) ===")
