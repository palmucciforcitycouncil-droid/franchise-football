#!/usr/bin/env python3
"""
QUICK FINAL CALIBRATION TEST - Single Season
Quick verification of the final PBP v2 calibration adjustments.
"""
...
def quick_calibration_test():
    """Quick single-season test for final calibration"""
    
    print("QUICK FINAL CALIBRATION TEST - SINGLE SEASON")
    print("=" * 45)
    ...
    # Run single season for quick verification
    season = 2025
...
if __name__ == "__main__":
    try:
        success = quick_calibration_test()
        if success:
            print("\nFINAL PBP CALIBRATION SUCCESSFUL!")
        else:
            print("\nFINAL PBP CALIBRATION NEEDS FURTHER ADJUSTMENT!")
            sys.exit(1)
    except Exception as e:
