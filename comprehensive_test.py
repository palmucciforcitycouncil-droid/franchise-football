#!/usr/bin/env python3
"""
Comprehensive three-season simulation test with corrected home field advantage.
"""
...
def comprehensive_three_season_test():
    """Run comprehensive three-season simulation"""
    ...
    def _points_from_yards_v2(home_abbr: str, away_abbr: str) -> Tuple[int, int]:
        """Convert yardage to realistic scores with proper home field advantage."""
        base_seed = int(os.environ.get("LEAGUE_SEED", "2025"))
    ...
    def simulate_pbp_events():
        """Simulate realistic PBP events"""
        base_seed = int(os.environ.get("LEAGUE_SEED", "2025"))
    ...
    print("=== COMPREHENSIVE THREE-SEASON SIMULATION ===")
    ...
    for season in range(2025, 2028):
        ...
        for game in range(272):
            ...
            # Simulate PBP events
            plays, punts, turnovers, tds, fgs = simulate_pbp_events()
...
if __name__ == "__main__":
    try:
        comprehensive_three_season_test()
